export const BOT_MESSAGES = {
  ...
  LOADER: '⏳',
  REWRITE_POST:
    'Пост занадто довгий! Потрібно прибрати зайву "воду", при цьому зберегти головну думку та зберегти користь даного посту. Максимальна довжина посту повинна бути не більшою за {POST_LENGTH} символів із пробілами та переносами!',
};
